...
extension BaseViewController {
    ...
    func openVertical<T>(storyBoardIdentifier: String = "Main",animate: Bool = true,_ attacher: (T) -> Void = {_ in } ) -> T where T: UIViewController{
        return navigationController!.openVertical(storyBoardIdentifier: storyBoardIdentifier, animate: animate, attacher)
    }
...
extension UINavigationController {
    ...
    //MARK:- Push View Controller Vertically
    func openVertical<T>(storyBoardIdentifier: String = "Main",animate: Bool = true,_ attacher: (T) -> Void = {_ in } ) -> T where T: UIViewController{
