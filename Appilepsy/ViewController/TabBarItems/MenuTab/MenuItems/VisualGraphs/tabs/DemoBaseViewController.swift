...
class DemoBaseViewController: BaseViewController, ChartViewDelegate {
    private var optionsTableView: UITableView? = nil
    let parties = ["Medicine A", "Medicine B", "Medicine C", "Medicine D", "Medicine E", "Medicine F",
                   "Medicine G", "Medicine H", "Medicine I", "Medicine J", "Medicine K", "Medicine L",
                   "Medicine M", "Medicine N", "Medicine O", "Medicine P", "Medicine Q", "Medicine R",
                   "Medicine S", "Medicine T", "Medicine U", "Medicine V", "Medicine W", "Medicine X",
                   "Medicine Y", "Medicine Z"]
...
public class DayAxisValueFormatter: NSObject, AxisValueFormatter {
    ...
    public func stringForValue(_ value: Double, axis: AxisBase?) -> String {
        ...
        if let chart = chart,
            ...
            let dayOfMonth = determineDayOfMonth(forDays: days, month: month + 12 * (year - 2020))
            var appendix: String
